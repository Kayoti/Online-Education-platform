...
$tot_questions = sizeof($questions);
$question_no = mt_rand(0,$tot_questions-1);
$question_selected = $questions[$question_no];

	if(!$fgmembersite->UpdateQuestionAnswered($course_id,$week_no,$stud_id,$question_selected))
	{
...
<li>B: Your question will appear.  You’ll have 15 seconds to gather your thoughts.</li></ul><br>
Step 3: Once the 15 seconds reaches zero, it’s time to present<br>Good luck!
		...
		<div class="span4 offset1" style="" >
			...
			<div class="control-group success" id="generator">
				<label class="control-label" for="genRandom" style="color:#666666; font-size:24px; font-weight:300;">Answer the question:</label>
			...
			<div class="container" id="stopwatch" style="display: inline">
				<input class="btn btn-large btn-block btn-info" id="present" name="pButton" value="Respond" type="button" onclick="buttontocd(); getQ('<?php echo $question_selected;?>'); document.getElementById('present').disabled=true;"/>
			</div>
			<br>
