...
session_start();
$week_no=  $_SESSION['week'];
$course_id = $_SESSION['class'];

$direction=('../Wowza/content/'.$fgmembersite->Userid().'-response-week-'.$week_no.'-course-'.$course_id.'.flv');
...
$fileName = $fgmembersite->Userid()."-response-week-".$week_no.'-course-'.$course_id;
$fgmembersite->UpdateRespSubmit($course_id,$week_no,$stud_id,$fileName);
...
$config['connectionstring']='rtmp://50.62.41.7/hdfvr';
