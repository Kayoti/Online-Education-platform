...
<section class="content">
	...
	<div class="container">
		<div class="row">
			<h2 style="display:inline; vertical-align: middle;"><i class="icon-comments-alt">&nbsp&nbsp</i>Welcome!</h2>
			<p style="margin-left: 45px;">Step 1:  Please fill out your “personal and institute information” by clicking on the Edit Info button.</p>
			<p style="margin-left: 45px;">Step 2:  Select the course tab above to enroll for your course.</p>
			<p style="margin-left: 45px;">Step 3:  Once enrolled and approved, the “make a payment” will appear.  Make your payment and begin your course.</p>
			
			<h2 style="display:inline; vertical-align: middle;"><i class="icon-user">&nbsp&nbsp</i>Personal Information</h1>
			...
			<h3><p id="student_name_id" style="margin-left: 45px;"><?php echo $student_profile["s_fname"].' '.$student_profile["s_lname"];?><?php if($student_profile["student_institute_id"]!=NULL) echo ' - '.$student_profile["student_institute_id"]?></p></h2>
			<h4><p id="student_email" style="margin-left: 45px;"><i class="icon-envelope-alt">&nbsp&nbsp</i><?php echo $student_profile["email_id"]?></p></h3>
			<?php if($student_profile["phone_no"]!=NULL){ echo '<h4><p id="student_phno" style="margin-left: 45px;"><i class="icon-phone">&nbsp&nbsp</i>'; echo $student_profile["phone_no"];echo '</p></h3>';}?>
			<h2 style="display:inline; vertical-align: middle;"><i class="icon-book">&nbsp&nbsp</i>Institute Information</h1>
			<a class="btn btn-logo" style="display:inline; vertical-align: middle; margin-left: 20px;" href="editprofile.php">Edit Info <i class="icon-edit icon-white"></i></a>
			<h3><p id="university_name" style="margin-left: 45px;"><?php if($student_university["u_name"]!=NULL)echo $student_university["u_name"];
																		 else echo "No Information Available";?></p></h2>
			<h4><p id="university_address" style="margin-left: 45px;"><?php if($student_university["u_street"]!=NULL)echo $student_university["u_street"];
																		 else echo "";?></p></h3>
			<h4><p id="university_street_province_postal" style="margin-left: 45px;"><?php if($student_university["u_city"]!=NULL&&$student_university["u_postalcode"]!=NULL&&$student_university["u_province"])echo $student_university["u_city"].", ".$student_university["u_province"]." ".$student_university["u_postalcode"];
																		 else echo "";?></p></h3>
			<h4><p id="university_country" style="margin-left: 45px;"><?php if($student_university["u_country"]!=NULL)echo $student_university["u_country"];
																		 else echo "";?></p></h3><br>
