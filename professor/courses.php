...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<div class="container">
		<div class="row">
			<div class="span6">
			<p class="lead">To add a new course, please click “Add New Course” and complete the course information form.</p>  
                <?php
                  require_once("../include/membersite_config.php");
                  $course_res = $fgmembersite->GetCourses($prof_id);    
                  $i =1;
                  foreach ($course_res as $course){
                      echo "<h3 class=''><div class='number-circle'>";
                      echo $i++;
                      $c_id = $course["course_id"];
					  $course_university = $fgmembersite->GetCourseInstitue($c_id);
                      echo "</div><a href='courseinfo.php?course_id=$c_id'>";
			...
			<div class="span6 text-right">
				<a class="btn btn-large btn-logo" href="addnewcourse.php">Add New Course</a>
			</div>
		</div>
	</div>
...
</html><!-- Last Updated on 2013-09-22 T 02:58:00 -04:00 -->
