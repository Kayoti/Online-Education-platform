...
{
    $stud_id = $_GET["student_evaluated_id"];
}
if(isset($_GET["week_no"]))
{
    $max_week = $_GET["week_no"];
}
...
<div class="navbar">
	<div class="navbar-inner">
		...
		<ul class="nav">
			<li class=""><a href="courseinfo.php?course_id=<?php echo $crs_id;?>">Course Information</a></li>
			<li class="divider-vertical"></li>
			<li class="active"><a href="students.php?course_id=<?php echo $crs_id;?>">Students</a></li>
			<li class="divider-vertical"></li>
			<li class=""><a href="topics.php?course_id=<?php echo $crs_id;?>">Topics</a></li>
			<li class="divider-vertical"></li>
					...
					echo '<div class="span6" style="padding-right: 20px; border-right: 1px solid #ccc;">';
						echo '<div class="text-center">';
							...
							echo '<div class="video-container" style="padding-left:70px;">';
								 ...
								 $video_id = $fgmembersite->GetEvalVid($crs_id,$weekcount,$stud_id);
								  $videoResponse_id=$fgmembersite->GetEvalResponseVid($crs_id,$weekcount,$stud_id);
								 echo '<script type="text/javascript">';
												   ...
												   echo "jwplayer('my-video-ppt".$weekcount."').setup({";
														...
														echo "playlist: [";
														echo "{";						
														echo 'file: "../wowza/content/'.$video_id.'.flv",';
							...
							echo '<table class="table">';
								...
								if(!empty($evaluations))
								{
									foreach($evaluations as $eval)
									{
										...
										{
											echo '<tr>';
												echo '<td style="vertical-align: bottom; text-align: center;"><a href="#" onClick="return false;" data-html="true" data-toggle="tooltip" data-placement="left" title="'.$fgmembersite->Sanitize($eval["comments"]).'">Instructor</a></td>';
									...
									foreach($evaluations as $eval)
									{
										...
										{
											$i++;
											$student = $fgmembersite->GetStudentProfile($eval["evaluated_by_id"]);
											echo '<tr>';
											if($eval["evaluated_by_id"]==$stud_id)
											{
												echo '<td style="vertical-align: bottom; text-align: center;"><a href="#" onClick="return false;" data-html="true" data-toggle="tooltip" data-placement="left" title="'.$fgmembersite->Sanitize($eval["comments"]).'">Student - Self</a></td>';
												echo '<td style="vertical-align: bottom; text-align: center;">N/A</td>';
											}
											else
											{
												echo '<td style="vertical-align: bottom; text-align: center;"><a href="#" onClick="return false;" data-html="true" data-toggle="tooltip" data-placement="left" title="'.$fgmembersite->Sanitize($eval["comments"]).'">'.$student["s_fname"].' '.$student["s_lname"].'</a></td>';
												echo '<td style="vertical-align: bottom; text-align: center;">'.$eval["presentation_marks"].'</td>';
											}
											echo '</tr>';
										}
							...
							echo '<div class="video-container" style="padding-left:60px;">';
								 ...
								 echo '<script type="text/javascript">';
												   echo "jwplayer('my-video-response".$weekcount."').setup({";
														...
														echo 'playlist: [';
														echo '{';							
														echo 'file: "../wowza/content/'.$videoResponse_id.'.flv",';
														echo 'title: "Play Video"';
														echo '}';
													echo ']';
													echo '});';
