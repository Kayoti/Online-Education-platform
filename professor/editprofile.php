...
$professor_university = $fgmembersite->GetProfessorInstitue($prof_id);
 ...
 if($subname)
    {
       if($fgmembersite->UpdateProfessorProfile($prof_id))
        {
	...
	<div class="container">
		<div class="row">
			...
			<div class="control-group span6">
				...
				<div class="controls">
					<input id="fname" name="fname" type="text" value="<?php echo $professor_profile["first_name"]?>" class="input input-block" disabled="">
			...
			<div class="control-group span6">
				...
				<div class="controls">
					<input id="lname" name="lname" type="text" value="<?php echo $professor_profile["last_name"]?>" class="input input-block" disabled="">
					<p class="help-block"></p>
				</div>
			</div>
			<div class="control-group span6">
				...
				<div class="controls">
					<input id="email" name="email" type="email" value="<?php echo $professor_profile["email_id"]?>" class="input input-block" disabled="">
					<p class="help-block"></p>
				</div>
			</div>
			<div class="control-group span6">
				...
				<div class="controls">
					<input id="phno" name="phno" type="text" maxlength="10" placeholder="No Spaces or Hyphens" value="<?php echo $professor_profile["phone_no"]?>" class="input input-block">
					<p class="help-block"></p>
				</div>
			</div>
			</fieldset>
				...
				<div class="controls">
					<select class="selectpicker" id="u_list" name="u_list" tabindex="3" onChange="name_click()">
						...
						<?php
							...
							else if($professor_university!=NULL)
							{
								echo "<option name='ulist' value='".$professor_university["u_name"]."'>".$professor_university["u_name"]."</option>";
							}
							else
							{
